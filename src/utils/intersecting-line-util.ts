...
const isIntersectToTop = (from: BaseComponent, to: BaseComponent) => {
...
const isIntersectToBottom = (from: BaseComponent, to: BaseComponent) => {
...
const isIntersectToLeft = (from: BaseComponent, to: BaseComponent) => {
...
const isIntersectToRight = (from: BaseComponent, to: BaseComponent) => {
...
const isIntersectToVertical = (from: BaseComponent, to: BaseComponent) => {
...
const isIntersectToHorizontal = (from: BaseComponent, to: BaseComponent) => {
...
export const calcIntersectingLines = (target: BaseComponent, coms: BaseComponent[], scale: number) => {
